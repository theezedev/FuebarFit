...
import { StyleSheet, Text, View, Pressable, TextInput, Platform, TouchableOpacity } from 'react-native';
import FontAwesome from "@expo/vector-icons/FontAwesome";



export default function WorkoutRow ({workoutName, workoutType}) {
    ...
    const handleTouchableOpacityPress = () => {
        ...
        // let newValue = resultingString; // You can set the new value dynamically
